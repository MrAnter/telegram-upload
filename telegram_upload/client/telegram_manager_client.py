...
from telegram_upload.client.telegram_forward_client import TelegramForwardClient
...
class TelegramManagerClient(TelegramUploadClient, TelegramDownloadClient, TelegramForwardClient):
